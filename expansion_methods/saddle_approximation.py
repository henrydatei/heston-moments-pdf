...
from all_methods import scipy_mvsek_to_cumulants, saddlepoint_approximation
...
normal_approximation = saddlepoint_approximation(x, *scipy_mvsek_to_cumulants(normal_mean, normal_var, normal_skew, normal_exkurt))
lognorm_approximation = saddlepoint_approximation(x, *scipy_mvsek_to_cumulants(lognorm_mean, lognorm_var, lognorm_skew, lognorm_exkurt))
t_approximation = saddlepoint_approximation(x, *scipy_mvsek_to_cumulants(t_mean, t_var, t_skew, t_exkurt))
nct_approximation = saddlepoint_approximation(x, *scipy_mvsek_to_cumulants(nct_mean, nct_var, nct_skew, nct_exkurt))
