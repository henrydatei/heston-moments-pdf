...
\begin{align}
    1 + \frac{\gamma_1}{6}H_3(z) + \frac{\gamma_2^*}{24}H_4(z) &= 0 \notag \\
    \frac{\gamma_1}{6}H_3(z) &= -1 - \frac{\gamma_2^*}{24}H_4(z) \notag \\
    \gamma_1\cdot H_3(z) &= -6 - \frac{\gamma_2^*}{4}H_4(z) \notag \\
    \gamma_1 &= -\frac{6}{H_3(z)} - \frac{H_4(z)}{4\cdot H_3(z)}\gamma_2^* \notag \\
...
\begin{table}[h]
    ...
    \begin{tabular}{l|l|l|l|l|l|l|l}
        ...
        \hline
        $\mathcal{N}(\mu=0,\sigma=1)$ & 0 & 1 & 0 & 0 & 0 & 0 \\
...
\begin{align}
    ...
    f(x)_{EW} \approx \frac{1}{\sqrt{2\pi}}\exp\left(-\frac{z^2}{2}\right) \left[1 + \frac{\gamma_1}{6}H_3(z) + \frac{\gamma_2^*}{24}H_4(z) + \frac{\gamma_1^2}{72}H_6(z)\right]
\end{align}
To ensure the expansion remains a valid density, we solve for skewness $\gamma_1$ in the equation:
\begin{align}
    0 &= 1+\frac{\gamma_1}{6}H_3(z) + \frac{\gamma_2^*}{24}H_4(z) + \frac{\gamma_1^2}{72}H_6(z) \\
    \gamma_1 &= \pm\sqrt{-\frac{72}{H_6(z)} - 3\gamma_2^*\frac{H_4(z)}{H_6(z)} + 36\frac{H_3(z)^2}{H_6(z)^2}} - 6\frac{H_3(z)}{H_6(z)} \notag
\end{align}
This equation is valid as long as $H_6(z) \neq 0$, which occurs at six points:
\begin{align}
    z_{1/2} &= \pm \sqrt{5-\frac{5^{2/3}\left(1+\mathrm{i}\sqrt{3}\right)}{\sqrt[3]{2\left(2+\mathrm{i}\sqrt{6}\right)}} - \frac{\left(1-\mathrm{i}\sqrt{3}\right)\sqrt[3]{5\left(2+\mathrm{i}\sqrt{6}\right)}}{2^{2/3}}} = \pm 0.6167 \notag\\
    z_{3/4} &= \pm \sqrt{5-\frac{5^{2/3}\left(1-\mathrm{i}\sqrt{3}\right)}{\sqrt[3]{2\left(2+\mathrm{i}\sqrt{6}\right)}} - \frac{\left(1+\mathrm{i}\sqrt{3}\right)\sqrt[3]{5\left(2+\mathrm{i}\sqrt{6}\right)}}{2^{2/3}}} = \pm 1.8892 \notag \\
    z_{5/6} &= \pm \sqrt{5+\frac{10^{2/3}}{\sqrt[3]{2+\mathrm{i}\sqrt{6}}} + \sqrt[3]{10\left(2+\mathrm{i}\sqrt{6}\right)}} = \pm 3.3243 \notag
\end{align}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/edgeworth_positivity_boundary_intersections_3.png}
        \caption{zoomed out}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/edgeworth_positivity_boundary_intersections_4.png}
        \caption{zoomed in}
        \label{fig:ew_boundary_intersections_4}
    \end{subfigure}
    \caption{Intersections of Boundary Lines for Edgeworth Expansion, upper half.}
    \label{fig:ew_boundary_intersections_zoom}
\end{figure}
\begin{figure}[h]
    \centering
...
\begin{enumerate}
    ...
    \begin{align}
        1 + \frac{0.222}{6}H_3(z) + \frac{4.01}{24}H_4(z) + \frac{0.222^2}{72}H_6(z)<0 \notag
    \end{align}
