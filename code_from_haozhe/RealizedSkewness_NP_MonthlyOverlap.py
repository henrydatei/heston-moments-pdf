...
def rCumulants(hfData, method, months_overlap=5):
    if method == RM_ACJV:
...
def rMoments(hfData, method, months_overlap=5, Sk_out=15, Ku_out=20, standardize=False):

    cumulants = rCumulants(hfData, method, months_overlap)
...
def rSkewness(hfData, method, months_overlap=5):
    cumulants = rCumulants(hfData, method, months_overlap)
    rSkKu = cumus2skkurt(cumulants)    # output centered var, skewness and kurtosis
