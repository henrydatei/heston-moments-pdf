...
file_path = os.path.join(os.getcwd(), 'ConvergenceCheck_Heston_NP_diff_1y_kappa3_unc_10yburnout_mu0095_v0019.xlsx') 
...
rm_mean_200000 = np.mean(rm[:200000, :], axis=0).reshape(1,6)  
rm_std_200000 = np.std(rm[:200000, :], axis=0).reshape(1,6)  
rm_5_200000 = np.percentile(rm[:200000, :], 5, axis=0).reshape(1,6)
rm_95_200000 = np.percentile(rm[:200000, :], 95, axis=0).reshape(1,6)   
