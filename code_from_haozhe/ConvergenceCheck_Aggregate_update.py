...
from RealizedMomentsEstimator_Aggregate_update import rMoments_mvsek, rMoments_nc
...
def Chunk_RealizedMomentsEstimator(chunk):
    ...
    for column in df_logreturn.columns:
        rm.append(rMoments_mvsek(df_logreturn[column], method=technique, days_aggregate=22, m1zero=True, ret_nc_mom=True).to_numpy())
